...
\item Resolved audio dropouts by identifying and correcting an assembly timing error.
\end{itemize}
...
\noindent{I develop open source software to solve problems and hone my skills. I am currently working on ironfetch, a system information tool; ppd-rs, a Rust library for the power-profiles-daemon; memdev, a Rust library for getting system memory information; and more recently, lowpowerd, a small utility to automatically set low power modes on Linux. I focus on build automation and devops such as utilizing Github actions and Nix Hydra for continuous integration.}
